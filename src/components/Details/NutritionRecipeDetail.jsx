...
const NutritionRecipeDetail = () => {
  ...
  return (
    <div className="bg-green-200  min-h-screen flex items-center justify-center my-5 rounded-3xl">
      <Link
        to="/nutrition"
      ...
      <div className="bg-white shadow-2xl rounded-xl overflow-hidden flex w-full max-w-7xl h-[680px] p-5">
        {/* Left side - Image */}
