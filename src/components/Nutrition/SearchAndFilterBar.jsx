...
const SearchAndFilterBar = ({
  ...
  return (
    <motion.div
      ...
      className="mb-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4 bg-white border border-zinc-300 rounded-xl sm:rounded-xl md:rounded-full lg:rounded-full overflow-hidden p-2 shadow-md"
    >
      ...
      <div className="flex flex-row sm:flex-row w-full sm:w-auto space-y-0 sm:space-y-0 md:space-y-4 lg:space-y-4 space-x-4 sm:space-x-4 ">
        <button
