...
import { Clock, Flame, ChefHat, Leaf, Star } from "lucide-react";
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105">
      <div className="relative">
        ...
        <div className="absolute bottom-2 left-2 flex items-center bg-white px-2 py-1 rounded-full text-sm font-semibold text-yellow-500 shadow">
      ...
      <div className="p-4 bg-gray-50 border-t border-gray-100">
        <Link to={`/nutrition-recipe/${recipe.id}`}>
...
export default NutritionRecipeCard;