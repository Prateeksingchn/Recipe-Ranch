...
// const RecipeDetails = ({ recipeType }) => {
...
//   switch (recipeType) {
//     case 'breakfast':
//       recipe = breakfastRecipes.find(
//         (r) => r.name.toLowerCase().replace(/\s/g, '-') === recipeSlug
//       );
//       break;
//     case 'lunch':
//       recipe = lunchRecipes.find(
//         (r) => r.name.toLowerCase().replace(/\s/g, '-') === recipeSlug
//       );
//       break;
//     case 'dinner':
//       recipe = dinnerRecipes.find(
//         (r) => r.name.toLowerCase().replace(/\s/g, '-') === recipeSlug
//       );
//       break;
//     default:
...
//           Back to {recipeType.charAt(0).toUpperCase() +
//             recipeType.slice(1)}{" "}
//           Recipes
//         </button>
//       </Link>
